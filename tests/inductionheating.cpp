...
{	
    ...
    mesh mymesh("../../models/inductionheating.msh");
    ...
    curl(a).write(wholedomain, "../../results/inductionheating/b.pos");
    e.write(conductor, "../../results/inductionheating/e.pos");
    (sigma*e).write(conductor, "../../results/inductionheating/j.pos");
    v.write(conductor, "../../results/inductionheating/v.pos");
